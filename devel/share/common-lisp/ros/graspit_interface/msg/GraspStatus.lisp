...
(cl:defmethod cl:initialize-instance :after ((m <GraspStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GraspStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name graspit_interface-msg:<GraspStatus> is deprecated: use graspit_interface-msg:GraspStatus instead.")))

(cl:ensure-generic-function 'grasp_status-val :lambda-list '(m))
(cl:defmethod grasp_status-val ((m <GraspStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader graspit_interface-msg:grasp_status-val is deprecated.  Use graspit_interface-msg:grasp_status instead.")
  (grasp_status m))

(cl:ensure-generic-function 'status_msg-val :lambda-list '(m))
(cl:defmethod status_msg-val ((m <GraspStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader graspit_interface-msg:status_msg-val is deprecated.  Use graspit_interface-msg:status_msg instead.")
  (status_msg m))

(cl:ensure-generic-function 'grasp_identifier-val :lambda-list '(m))
(cl:defmethod grasp_identifier-val ((m <GraspStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader graspit_interface-msg:grasp_identifier-val is deprecated.  Use graspit_interface-msg:grasp_identifier instead.")
  (grasp_identifier m))

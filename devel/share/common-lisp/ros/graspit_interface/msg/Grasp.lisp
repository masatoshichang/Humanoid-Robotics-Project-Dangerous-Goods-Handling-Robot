...
(cl:defmethod object_name-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader graspit_interface-msg:object_name-val is deprecated.  Use graspit_interface-msg:object_name instead.")
  (object_name m))

(cl:ensure-generic-function 'grasp_id-val :lambda-list '(m))
(cl:defmethod grasp_id-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader graspit_interface-msg:grasp_id-val is deprecated.  Use graspit_interface-msg:grasp_id instead.")
  (grasp_id m))

(cl:ensure-generic-function 'secondary_qualities-val :lambda-list '(m))
(cl:defmethod secondary_qualities-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader graspit_interface-msg:secondary_qualities-val is deprecated.  Use graspit_interface-msg:secondary_qualities instead.")
  (secondary_qualities m))

(cl:ensure-generic-function 'grasp_source-val :lambda-list '(m))
(cl:defmethod grasp_source-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader graspit_interface-msg:grasp_source-val is deprecated.  Use graspit_interface-msg:grasp_source instead.")
  (grasp_source m))

(cl:ensure-generic-function 'grasp_group-val :lambda-list '(m))
(cl:defmethod grasp_group-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader graspit_interface-msg:grasp_group-val is deprecated.  Use graspit_interface-msg:grasp_group instead.")
  (grasp_group m))

(cl:ensure-generic-function 'grasp_type-val :lambda-list '(m))
(cl:defmethod grasp_type-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader graspit_interface-msg:grasp_type-val is deprecated.  Use graspit_interface-msg:grasp_type instead.")
  (grasp_type m))

(cl:ensure-generic-function 'pre_grasp_pose-val :lambda-list '(m))
(cl:defmethod pre_grasp_pose-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader graspit_interface-msg:pre_grasp_pose-val is deprecated.  Use graspit_interface-msg:pre_grasp_pose instead.")
  (pre_grasp_pose m))

(cl:ensure-generic-function 'final_grasp_pose-val :lambda-list '(m))
(cl:defmethod final_grasp_pose-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader graspit_interface-msg:final_grasp_pose-val is deprecated.  Use graspit_interface-msg:final_grasp_pose instead.")
  (final_grasp_pose m))

(cl:ensure-generic-function 'pre_grasp_dof-val :lambda-list '(m))
(cl:defmethod pre_grasp_dof-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader graspit_interface-msg:pre_grasp_dof-val is deprecated.  Use graspit_interface-msg:pre_grasp_dof instead.")
  (pre_grasp_dof m))

(cl:ensure-generic-function 'final_grasp_dof-val :lambda-list '(m))
(cl:defmethod final_grasp_dof-val ((m <Grasp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader graspit_interface-msg:final_grasp_dof-val is deprecated.  Use graspit_interface-msg:final_grasp_dof instead.")
  (final_grasp_dof m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Grasp>)))
  ...
  "93371a0db54f716d8aa408e86b086783")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Grasp)))
  "Returns md5sum for a message object of type 'Grasp"
  "93371a0db54f716d8aa408e86b086783")

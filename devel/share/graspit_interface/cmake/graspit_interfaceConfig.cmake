...
if("TRUE" STREQUAL "TRUE")
  set(graspit_interface_SOURCE_PREFIX /home/masatoshichang/robotics/fetch_ws/src/graspit_interface)
  set(graspit_interface_DEVEL_PREFIX /home/masatoshichang/robotics/fetch_ws/devel)
  ...
  set(graspit_interface_INSTALL_PREFIX /home/masatoshichang/robotics/fetch_ws/install)
...
if(NOT "/home/masatoshichang/robotics/fetch_ws/devel/include;/home/masatoshichang/robotics/fetch_ws/src/graspit_interface/include " STREQUAL " ")
  set(graspit_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/masatoshichang/robotics/fetch_ws/devel/include;/home/masatoshichang/robotics/fetch_ws/src/graspit_interface/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'graspit_interface' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jared Weiss <jbw2140@columbia.edu>, Jake Varley <jakevarley@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'graspit_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/masatoshichang/robotics/fetch_ws/src/graspit_interface/${idir}'.  Ask the maintainer 'Jared Weiss <jbw2140@columbia.edu>, Jake Varley <jakevarley@gmail.com>' to fix it.")
    endif()
...
set(graspit_interface_EXPORTED_TARGETS "graspit_interface_generate_messages_cpp;graspit_interface_generate_messages_eus;graspit_interface_generate_messages_lisp;graspit_interface_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${graspit_interface_dep}_FOUND)
      find_package(${graspit_interface_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${graspit_interface_dep} REQUIRED ${depend_list})
  endif()
